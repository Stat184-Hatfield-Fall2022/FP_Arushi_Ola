...
```{r}
mostPopular <- sort(summary(as.factor(nytrees_1995$Spc_Common), decreasing=TRUE)[1:5])
mostPopular <- as.data.frame(mostPopular)
mostPopular

ggplot(
  data = mostPopular,
  mapping = aes(x = Spc_Common)
) +
  geom_bar()
